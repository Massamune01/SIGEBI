...
namespace SIGEBI.Application.Validators.Configuration.ClienteValidators
{
    public class ClienteCreateValidator : IValidatorBase<ClienteCreateDto>
    {
        ...
        private readonly ILogger<ClienteCreateValidator> _logger;

        public ClienteCreateValidator(IClienteRepository clienteRepository, ILogger<ClienteCreateValidator> logger)
        {
            _clienteRepository = clienteRepository;
            _logger = logger;
        }

        public async Task<ValidationResult> ValidateCreate(ClienteCreateDto entity)
        {
