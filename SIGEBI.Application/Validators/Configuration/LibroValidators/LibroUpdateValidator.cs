...
namespace SIGEBI.Application.Validators.Configuration.LibroValidators
{
    public class LibroUpdateValidator : IValidatorBase<LibroUpdateDto>
    {
        ...
        private readonly ILogger<LibroUpdateValidator> _logger;

        public LibroUpdateValidator(ILibrosRepository libroRepository, ILogger<LibroUpdateValidator> logger)
        {
        ...
        public async Task<ValidationResult> ValidateUpdate(LibroUpdateDto entity)
        {
