...
{
    public class BibliotecarioFacade : IBibliotecarioFacade
    {
        ...
        private readonly ILogger<BibliotecarioFacade> _logger;

        public BibliotecarioFacade(IBibliotecariosRepository bibliotecariosRepository, 
            IValidatorBase<BibliotecarioDto> validator, 
            ILogger<BibliotecarioFacade> logger)
        {
