...
namespace SIGEBI.Application.Facades_Classes.Configuration
{
    public class ClienteFacade : IClienteFacade
    {
        ...
        private readonly ILogger<ClienteFacade> _logger;
        private readonly IValidatorBase<ClienteDto> _Validator;

        public ClienteFacade(IClienteRepository clienteRepository, 
            ILogger<ClienteFacade> logger, IValidatorBase<ClienteDto> validator)
        {
        ...
        public async Task<ServiceResult> GetAllClienteAsync()
        {
            ServiceResult result = new ServiceResult();
            try
            {
